...
<template>
  <main>
    ...
    <div class="cards-list">
      <h1 v-if="route.params.id_tipo_obra == 1" class="playwrite-de-grund animate__animated animate__fadeInDown">Obras
        de Arte</h1>
      <h1 v-if="route.params.id_tipo_obra == 2" class="playwrite-de-grund animate__animated animate__fadeInDown">
        Artesanías</h1>
      <h1 v-if="route.params.id_tipo_obra == 3" class="playwrite-de-grund animate__animated animate__fadeInDown">Diseño
        Industrial</h1>
      <h1 v-if="route.params.id_tipo_obra == 4" class="playwrite-de-grund animate__animated animate__fadeInDown">Diseño
        Gráfico</h1>
